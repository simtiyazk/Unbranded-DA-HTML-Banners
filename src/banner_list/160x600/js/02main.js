...
App_banner.fn.anima = function() {
    ...
    tl.addLabel('frame1', '+=0')
        ...
        .to(lineframe1, 0.5, { height: 84, ease: Power1.easeOut }, 'frame1+=3')
        .to([line2frame1, emptydivforline2], 0.5, { top: 334, ease: Power1.easeOut }, 'frame1+=3')
        .to(line2frame1, 1, { left: 68, ease: Power1.easeOut }, 'frame1+=3.5')
        .to(frame1wrapper, 1, { left: -160, ease: Power1.easeOut }, 'frame1+=3.5')
