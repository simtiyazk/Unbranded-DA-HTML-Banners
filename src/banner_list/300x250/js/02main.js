...
App_banner.fn.anima = function() {
    ...
    tl.addLabel('frame1', '+=0')
        ...
        .to(lineframe1, 2, { left: 299, ease: Power1.easeOut }, 'frame1+=3')
        .to(lineframe1, 0, { zIndex: 2, ease: Power1.easeOut }, 'frame1+=4.05')
        .to(frame1wrapper, 1, { left: -300, ease: Power1.easeOut }, 'frame1+=3')
        .to(frame2wrapper, 1, { left: 0, ease: Power1.easeOut }, 'frame1+=3')
        // .to([frame2txt, frame2hepdeltablock, frame2hepblock], 0.4, { opacity: 1, ease: Power1.easeOut }, 'frame1+=3')

        .addLabel('frame2', '+=0')
        // .to(lineframe1, 1, { left: 299, zIndex: 2, ease: Power1.easeOut }, 'frame2+=3')
        // .to(hepbtxt2, 0.4, { opacity: 0.3, ease: Power1.easeOut }, 'frame2+=0')
        ...
        .to([frame2hepdeltablock, frame2hepblock], 0.5, { left: 94, ease: Power1.easeOut }, 'frame3+=0.5')
        .to(hepbtxt2, 0.3, { opacity: 1, ease: Power1.easeOut }, 'frame3+=1')
        .to(frame3txt, 0, { opacity: 1, ease: Power1.easeOut }, 'frame3+=1.4')
        .to([frame2hepdeltablock], 0.3, { top: 23, ease: Power1.easeOut }, 'frame3+=1.8')
        .to([frame2hepblock], 0.3, { top: 173, ease: Power1.easeOut }, 'frame3+=1.8')
